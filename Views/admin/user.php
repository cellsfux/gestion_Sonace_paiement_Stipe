...
Dans cette partie sont repertorier toutes les assurences de la sonas
</p>
</div>
...
<div class="media align-items-center">
<span class="avatar avatar-sm rounded-circle">
<img alt="Image placeholder" src="<?= URLROOT ?>uploads/img/<?= $lis->profilpic ?>">
</span>
<div class="media-body  ml-2  d-none d-lg-block">
<span class="mb-0 text-sm  font-weight-bold"><?= ucfirst($lis->prenom).' '. ucfirst($lis->nom) ?></span>
</div>
</div>
</td>
<td><?= $lis->phone ?></td>
...
<td>
  ...
  <a href="<?= URLROOT ?>admin/deleuser/<?= $lis->id ?>" class="btn btn-danger" id="delete">Supprimer</a>
